...
import { Star, MapPin, Phone, Globe, Calendar, MessageCircle, Mail } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-16 relative z-10">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8">
          ...
          <div className="space-y-4">
            {services.map(s => (
              <div key={s.id} className="flex justify-between items-center p-5 bg-gray-50 rounded-xl">
                <div>
                ...
                <div className="text-left">
                  ...
                  <Link to={createPageUrl(`BookAppointment?therapist=${therapist.id}&service=${s.id}`)}>
                    <Button size="sm" className="mt-2 bg-teal-600 hover:bg-teal-700">קבע תור</Button>
                  </Link>
                </div>
              </div>
            ))}
